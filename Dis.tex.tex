...
% Don't use a bullet point list but use actual syntax highlighting.
\begin{itemize}
...
% OUCH! Use bibtex or biblatex (which is better) - see my course notes on bibliographies
